...
class _ReservationWidgetState extends State<ReservationWidget>
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<WorkshopsRecord>(
      stream: WorkshopsRecord.getDocument(widget.wsRef!),
      builder: (context, snapshot) {
        ...
        final reservationWorkshopsRecord = snapshot.data!;
                        ...
                        children: [
                          Align(
                            ...
                            child: ClipRRect(
                              ...
                              child: Image.network(
                                reservationWorkshopsRecord.img,
                                width: double.infinity,
                                height: 476.0,
                                fit: BoxFit.cover,
                              ),
                                                    ...
                                                    padding:
                                                        const EdgeInsetsDirectional
                                                            .fromSTEB(0.0, 12.0,
                                                                0.0, 0.0),
                                                    child: Text(
                                                      'Time : ${reservationWorkshopsRecord.time}',
                          ...
                          if (confirmDialogResponse) {
                            await ReservationsRecord.collection
                                ...
                                .set(createReservationsRecordData(
                                  ...
                                  workshopID:
                                      reservationWorkshopsRecord.reference,
                                  time: '02:00pm',
                                  workshopName:
                                      reservationWorkshopsRecord.wname,
