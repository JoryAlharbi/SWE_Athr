              ...
              children: [
                Align(
                  ...
                  child: FlutterFlowButtonTabBar(
                    ...
                    labelColor: const Color(0xFF2C5B69),
                    unselectedLabelColor: const Color(0xFF57636C),
                    backgroundColor: const Color(0xFF72B6BF),
                    unselectedBackgroundColor: const Color(0xFFE0E3E7),
                    borderColor: const Color(0xFF2C5B69),
                    borderWidth: 2.0,
                    borderRadius: 12.0,
                    elevation: 0.0,
                    labelPadding:
                                ...
                                child: InkWell(
                                  ...
                                  child: Container(
                                    ...
                                    child: Padding(
                                      padding: const EdgeInsetsDirectional.fromSTEB(
                                          0.0, 5.0, 0.0, 0.0),
                                      child: StreamBuilder<WorkshopsRecord>(
                                        stream: WorkshopsRecord.getDocument(
                                            listViewReservationsRecord
                                                .workshopID!),
                                        builder: (context, snapshot) {
                                          // Customize what your widget looks like when it's loading.
